    ...
    <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="card bg-slate-800/50">
        ...
        <div className="space-y-2 text-sm text-slate-400">
          <p>
            <span className="text-slate-300">Versión:</span> 1.0.0
          </p>
          <p>
            <span className="text-slate-300">Última actualización:</span> {new Date().toLocaleDateString('es-ES')}
          </p>
          <p>
            <span className="text-slate-300">Almacenamiento:</span> IndexedDB (Local)
          </p>
          <p className="mt-4 text-slate-500">
            Todos tus datos se guardan localmente en tu dispositivo. Ningún dato se envía a servidores externos.
          </p>
        </div>
      </div>
    </div>
